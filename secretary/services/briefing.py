...
async def schedule_daily_briefings(app: Application):
    ...
    scheduler.add_job(send_briefing, 'cron', hour=config.BRIEFING_MORNING_HOUR, minute=0)
    # HKT 21:00 evening briefing
    scheduler.add_job(send_briefing, 'cron', hour=config.BRIEFING_EVENING_HOUR, minute=0)
